<?php /* Template Name: Plantilla CIDAE */ ?>
<!DOCTYPE html>
						...
						<div class="tab-pane fade p-3 fondo-gris-os show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							...
							<div class="col-12 p-2 px-md-5 text-justify">
								<p class="pt-sans">
									...
									<br><br>
									Por esta razón y de acuerdo a la visión y misión, la investigación en la AUNAR, se concibe como un proceso permanente de producción de conocimiento, generador de competencias que permiten al estudiante y al egresado desenvolverse en distintos campos con pertinencia y capacidad creadora, con la habilidad de hacer, de ser y retroalimentar su conocimiento a través de la práctica profesional.
									<br><br>
									Como principios de la investigación en la institución se identifican:
									<br><br>
									
									- La articulación entre docente - estudiante orientada a la investigación.
									<br>
