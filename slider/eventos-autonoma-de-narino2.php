	<?php
						...
						$args = array('post_type' => 'eventos','posts_per_page' => 9,'numberposts' => '10', 'post_status' => 'publish');
                ...
                /*******************************************************************************/
                          ...
                          <div class="carousel-item p-1 p-sm-4 <?php echo$active;?> ">
                            <!-- <div class="row p-2 m-1 m-sm-5 "> -->
                              ...
                              // SE HACE LA VALIDACION PARA DAR EL EFECTO EN EL PADING LEFT pl-sm-5 DE EVENTOS
                               if($contador%2==0)
                                {
                                  $columna1='col-sm-4';
                                  $columna2='col-sm-8';
                                  ...
                                  <div class="col-12 <?php echo $columna2; ?> d-flex justify-content-center justify-content-sm-start">
                                    <div class="row texto-azul pt-sans">
                                      <div class="col-lg-12 text-center text-lg-left text-md-left f-negrita f-size-16"><label class="border-bottom borde-azul">
                                        ...
                                        <?php echo '<a class="pt-sans sin-texto-subrayado texto-azul-os hover-texto-blanco" href="' . get_permalink($recent["ID"]) . '">' .   $recent["post_title"].'</a> '; ?>
                                      </label></div>
                 ...
                 <a class="carousel-control-prev bg-dark" href="#mas_eventos" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon bg-dark rounded-circle" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next bg-dark" href="#mas_eventos" role="button" data-slide="next">
