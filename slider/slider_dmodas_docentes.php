  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="inscripciones"> 
        <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_dmodas.jpg" alt="Director Diseño de Modas Aunar"></a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_dmodas_director.jpg" alt="Director Diseño de Modas Aunar">
      <!--div class="carousel-caption">
