  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="inscripciones.php"> 
        <img class="d-block w-100" src="img/carreras/slider_dental.jpg" alt="Director Mecánica Dental Aunar"></a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="img/carreras/slider_dental_director.jpg" alt="Director Mecánica Dental Aunar">
      <!--div class="carousel-caption">
