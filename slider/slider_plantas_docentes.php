  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="inscripciones"> 
        <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_plantas.jpg" alt="Director Plantas aromáticas Aunar"></a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_plantas_director.jpg" alt="Director Plantas aromáticas Aunar">
      <!--div class="carousel-caption">
