  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="inscripciones"> 
        <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_ing_mecanica.jpg" alt="Director Ingeniería mecánica"></a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_ing_mecanica_director.jpg" alt="Director Ingeniería mecánica">
      <!--div class="carousel-caption">
