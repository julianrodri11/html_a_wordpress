  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="inscripciones.php"> 
        <img class="d-block w-100" src="img/carreras/slider_ing_electronica.jpg" alt="Director Ingeniería electrónica"></a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="img/carreras/slider_ing_electronica_director.jpg" alt="Director Ingeniería electrónica">
      <!--div class="carousel-caption">
