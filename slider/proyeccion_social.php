  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="inscripciones.php"> 
        <img class="d-block w-100" src="http://placehold.it/600x300" alt="First slide"></a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="http://fakeimg.pl/600x300" alt="Second slide">
      <!--div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="http://imgholder.ru/600x300" alt="Second slide">
      <!--div class="carousel-caption">
        <h3>Lorem ipsum.</h3>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="http://dummyimage.com/600x300" alt="Third slide">
      <!--div class="carousel-caption">
        <h3>Lorem.</h3>
