  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="inscripciones"> 
        <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_ing_informatica.jpg" alt="Director Ingeniería Informática"></a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php bloginfo('template_url')?>/img/carreras/slider_ing_informatica_director.jpg" alt="Director Ingeniería Informática">
      <!--div class="carousel-caption">
