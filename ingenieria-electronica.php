...
<html <?php language_attributes();?>>
	...
	<head>
		...
		<meta name="description"
			content="El ingeniero(a) será capaz de desempeñarse en el sector industrial, en el diseño, investigación, desarrollo, innovación, consultoría, gestión, supervisión, implementación y mantenimiento de sistemas electrónicos">
	...
	<body>
		...
		<div class="container-fluid">
			<div class="row ">
				<div class="col-12 col-lg-5 col-md-6 p-5">
					<div class="col-12 ">
						<h3 class="fuente-institucional texto-amarillo f-negrita">Identificación del programa</h3>
					</div>
					<div class="col-12">
						<table class="table table-bordered  table-striped pt-sans f-size-14 texto-azul-os">
							...
							<tbody>
								...
								<tr>
									...
									<td class="borde-1 borde-amarillo border-top-0 border-bottom-0">Ingeniería Electrónica</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 borde-amarillo border-top-0 border-bottom-0">Ingeniero Electrónico</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 borde-amarillo border-top-0 border-bottom-0"> Acuerdo Consejo Directivo No. 15 del
										15 de septiembre 2005.</td>
								</tr>
								<tr>
									<td class="borde-1 borde-amarillo border-bottom-0 border-top-0">Resolución de Registro Calificado:
									</td>
									<td class="borde-1 borde-amarillo border-top-0 border-bottom-0">10546 de agosto 2013</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 borde-amarillo border-top-0 border-bottom-0">174</td>
								</tr>
								<tr>
					...
					<div class="col-12 mt-5">
						<label class="fuente-institucional texto-amarillo f-negrita">CONTACTOS</label><br>
						<label class="fuente-institucional ">ingenieria.electronica@aunar.edu.co</label>
					</div>
				</div>
				<div class="col-12 col-lg-7 col-md-6 p-5">
					<div class="col-12">
						<h3 class="fuente-institucional texto-amarillo f-negrita">Objetivo General</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<p>El Programa de Ingeniería Electrónica que ofrece la Corporación Universitaria Autónoma de Nariño posee el
							contenido curricular de la formación profesional que responde a los lineamientos nacionales e
							internacionales, complementando los elementos teóricos con los aspectos prácticos en un ambiente integral
							y dinámico en la formación de las competencias y saberes que dan competitividad al egresado, en un
							contexto cada vez más globalizado.
						</p>
						<p>
							Específicamente el <strong> PROFESIONAL DE INGENIERÍA ELECTRÓNICA</strong>, será capaz de desempeñarse en
							el sector industrial, en el diseño, investigación, desarrollo, innovación, consultoría, gestión,
							supervisión, implementación y mantenimiento de sistemas electrónicos. El campo del conocimiento del
							ingeniero en electrónica de la autónoma de Nariño está centrado en el diseño y desarrollo de todo tipo de
							circuitos electrónicos con alto índice de complejidad, además dar soporte en los campos de las
							telecomunicaciones, electro medicina, automatización en las organizaciones en donde se desempeñe.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="row col-12 p-2">
					<div class="row col-12 p-2  d-flex justify-content-end ">
						<div class="col-12 col-lg-7 mt-2 hvr-wobble-horizontal text-right fuente-institucional">
							<div class="col-12 text-white f-negrita f-size-18 text-right">¿Desea inscribirse en este programa?</div>
							<div class="col-12 text-white f-size-16 text-right">Encuentra toda la información</div>
							<div class="col-12 f-size-16 text-right"><a href="inscripciones" class="texto-amarillo f-negrita">Aquí</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container-fluid ">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h3 class="fuente-institucional texto-amarillo f-negrita text-center">Misión</h3>
					</div>
					<div class="col-12 pt-sans text-justify">La misión del programa de Ingeniería Electrónica de la Corporación
						Universitaria Autónoma de Nariño, es la formación de Ingenieros en electrónica, competitivos en el mercado
						de la automatización, el control, las telecomunicaciones y la electro medicina, fieles a los principios
						Institucionales de excelencia académica y proyección social a partir de la recopilación de una excelente
						planta docente, un currículo pertinente con las problemáticas del entorno y las herramientas necesarias para
						una formación integral de calidad.</div>
				</div>
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
					...
					<div class="col-12 pt-sans text-justify">El programa de ingeniería electrónica de la Corporación Universitaria
						...
						alta responsabilidad social y cultural, ofreciendo a los beneficiaros de este programa el mejoramiento
						constante de su calidad de vida.</div>
				</div>
			</div>
		</div>
		<div class="container-fluid fondo-gris-c">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h5 class="fuente-institucional texto-amarillo f-negrita">AL GRADUARTE</h5>
						<h3 class="fuente-institucional texto-amarillo f-negrita text-center">¿DÓNDE PUEDES TRABAJAR?</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
				...
				<div class="col-12 col-sm-6 border-left borde-amarillo">
					<div class="col-12">
						<h5 class="fuente-institucional texto-amarillo f-negrita">¿QUÉ HACE UN</h5>
			...
			<div class="row  fuente-institucional texto-azul">							
					<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
						<a class="texto-azul-os sin-texto-subrayado" target="_blanck"
							href="<?php bloginfo('template_url')?>/docs/malla_curricular/ingenieria_electronica.pdf"
					...
					<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
						<a class="texto-azul-os sin-texto-subrayado" target="_electronica" href="grupos-de-investigacion#grupo2"
