        ...
        <div class="container-fluid bg-white">
          <div class="row">            
            <div class="col-12 p-2 m-1 ">
              <div class="row">
                <div class="col-12 p-2 text-center"><img data-src="<?php bloginfo('template_url')?>/img/aunar.jpg" width="30%" alt="logo AUNAR" class="lazyload img-fluid rounded-circle"></div>
