  ...
  <div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="carouselExampleIndicators_inicial" class="carousel slide animated zoomInDown" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/sitioenconstruccion_aunar.jpg" alt="Inscribete en nuestro programas">
        ...
        <!-- <div class="carousel-item">
          <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/Pendones-inscripciones-2018-2.jpg" alt="Estudia con nosotros">
          <div class="carousel-caption">
          <h3>Lorem.</h3>
