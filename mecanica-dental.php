	...
	<body>
			...
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%"
						src="<?php bloginfo('template_url')?>/img/carreras/mecanica-dental-aunar.jpg"
						alt="Mecánica dental autónoma de nariño" />
				</div>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="row ">
				<div class="col-12 col-lg-5 col-md-6 fondo-gris-c p-5">
					<div class="col-12 ">
						<h3 class="fuente-institucional f-color-mdental f-negrita">Identificación del programa</h3>
					</div>
					<div class="col-12">
						<table class="table table-bordered  table-striped pt-sans f-size-14 texto-azul-os">
							...
							<tbody>
								...
								<tr>
									...
									<td class="borde-1 b-color-mdental border-top-0 border-bottom-0">Técnico Laboral por competencias en
										Mecánica Dental</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="borde-1 b-color-mdental border-bottom-0 border-top-0">Resolución de Registro Calificado:
									</td>
									<td class="borde-1 b-color-mdental border-top-0 border-bottom-0"></td>
								</tr>
								<tr>
				...
				<div class="col-12 col-lg-7 col-md-6 p-5">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-mdental f-negrita">Objetivo General</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						...
						<p>La formación del <strong>Técnico Laboral por competencias en Mecánica Dental</strong>, desarrolla un
							vasto componente de conocimientos técnicos, prácticas y habilidades que promueven la formación integral,
							posibilitando dotar al estudiante de técnicas adecuadas para el trabajo y una alta participación ciudadana
							y comunitaria. Lo anterior permitirá alcanzar como resultado la formación de un técnico integral de
							calidad, capaz de ser independiente e innovador.|</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid ">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-mdental f-negrita text-center">Misión</h3>
					</div>
					<div class="col-12 pt-sans text-justify">Formar tecnólogos profesionales éticos, capaces de dominar los
						procesos, principios y componentes del área de la aparatología y ortopedia maxilar, utilizando técnicas de
						estudio e investigación para la elaboración de todo tipo de trabajos en el desarrollo de la profesión.
						Colaborar en el proceso de rehabilitación con el odontólogo y desarrollar la experiencia necesaria en el
						manejo de equipos, materiales, e instrumental en conjunto de las nuevas aplicaciones tecnológicas,
						relacionadas con la carrera. </div>
				</div>
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-mdental f-negrita text-center">Visión</h3>
					</div>
					<div class="col-12 pt-sans text-justify">Ser un programa reconocido a nivel regional, nacional e internacional
						posicionándolo en el ámbito educativo de la salud oral, aportando a la investigación, responsabilidad
						social, formación permanente teniendo como resultado excelencia de sus egresados. Para ello, la institución
						contará con un recurso humano altamente calificado, desde el punto de vista académico y moral, que vele por
						el crecimiento del Programa y un continuo perfeccionamiento profesional.
					</div>
				</div>
			</div>
		</div>
		<div class="container-fluid fondo-gris-c">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h5 class="fuente-institucional f-color-mdental f-negrita">AL GRADUARTE</h5>
						<h3 class="fuente-institucional f-color-mdental f-negrita text-center">¿DÓNDE PUEDES TRABAJAR?</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<div class="row">
							<div class="col-12">El objetivo fundamental de la Corporación Universitaria Autónoma de Nariño es la
								capacitación técnica y científica del estudiante, para que realice actividades propias de ésta profesión
				...
				<div class="col-12 col-sm-6 border-left b-color-mdental">
					<div class="col-12">
						<h5 class="fuente-institucional f-color-mdental f-negrita">¿QUÉ HACE UN</h5>
						<h3 class="fuente-institucional f-color-mdental f-negrita text-center">TÉCNICO LABORAL POR COMPETENCIAS EN
							MECÁNICA DENTAL?</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<p> Quien aspira a ingresar al Programa <strong> Técnico Laboral por competencias en Mecánica
								Dental</strong> de la Corporación Universitaria Autónoma de Nariño, debe ser egresado de la Educación
							Media Superior o tener cursado y aprobado la educación básica secundaria (9no) y ser mayor de 16 años. El
							aspirante debe tener actitudes personales compatibles con las necesidades sociales y los avances en salud
							y sensibilidad frente a las necesidades humanas de la salud, demostrar sentido crítico, liderazgo social y
							...
							en cada uno de los procesos requeridos para su desempeño contributivo, en aras de mejorar la salud oral de
							la comunidad.
						</p>
					</div>
			...
			<div class="row  fuente-institucional texto-azul">
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
					<a class="texto-azul-os sin-texto-subrayado" target="_blanck"
						href="<?php bloginfo('template_url')?>/docs/malla_curricular/mecanica_dental.pdf" data-toggle="tooltip"
				...
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
					<a class="texto-azul-os sin-texto-subrayado" target="_mecanica_dental" href="grupos-de-investigacion#grupo6"
