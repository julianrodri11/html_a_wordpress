<?php /* Template Name: Plantilla Mecánica Dental */ ?>
<!DOCTYPE html>
<html <?php language_attributes();?>>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/carreras/mecanica-dental-aunar.jpg" alt="Mecánica dental autónoma de nariño" />
				</div>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="row ">
				<div class="col-12 col-lg-5 col-md-6 fondo-gris-c p-5">
					<div class="col-12 "> <h3 class="fuente-institucional f-color-mdental f-negrita">Identificación del programa</h3></div>
					<div class="col-12">
					...
					<div class="col-12 mt-5">
						<label class="fuente-institucional f-color-mdental f-negrita">CONTACTOS</label><br>
						<label class="fuente-institucional ">diana.revelo@aunar.edu.co</label>
					</div>
				</div>
				<div class="col-12 col-lg-7 col-md-6 p-5">
					<div class="col-12"> <h3 class="fuente-institucional f-color-mdental f-negrita">Objetivo General</h3></div>
					<div class="col-12 pt-sans text-justify">
						<p>El Programa <strong>Técnico Laboral por competencias en Mecánica Dental</strong> que ofrece la Corporación Universitaria Autónoma de Nariño a la Comunidad de Nariño, está estructurado dentro de un contexto Nacional e Internacional con un contenido Curricular practico, integral y dinámico en la formación de las Competencias que lleven al Graduado a competir dentro de un entorno y política de globalización que vive el País.
						</p>
						<p>La formación del <strong>Técnico Laboral por competencias en Mecánica Dental</strong>, desarrolla un vasto componente de conocimientos técnicos, prácticas y habilidades que promueven la formación integral, posibilitando dotar al estudiante de técnicas adecuadas para el trabajo y una alta participación ciudadana y comunitaria. Lo anterior permitirá alcanzar como resultado la formación de un técnico integral de calidad, capaz de ser independiente e innovador.|</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid ">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12"> <h3 class="fuente-institucional f-color-mdental f-negrita text-center">Misión</h3></div>
					<div class="col-12 pt-sans text-justify">Formar tecnólogos profesionales éticos, capaces de dominar los procesos, principios y componentes del área de la aparatología y ortopedia maxilar, utilizando técnicas de estudio e investigación para la elaboración de todo tipo de trabajos en el desarrollo de la profesión. Colaborar en el proceso de rehabilitación con el odontólogo y desarrollar la experiencia necesaria en el manejo de equipos, materiales, e instrumental en conjunto de las nuevas aplicaciones tecnológicas, relacionadas con la carrera. </div>
				</div>
				<div class="col-12 col-sm-6 ">
					<div class="col-12"> <h3 class="fuente-institucional f-color-mdental f-negrita text-center">Visión</h3></div>
					<div class="col-12 pt-sans text-justify">Ser un programa reconocido a nivel regional, nacional e internacional posicionándolo en el ámbito educativo de la salud oral, aportando a la investigación, responsabilidad social, formación permanente teniendo como resultado excelencia de sus egresados. Para ello, la institución contará con un recurso humano altamente calificado, desde el punto de vista académico y moral, que vele por el crecimiento del Programa y un continuo perfeccionamiento profesional.
					</div>
				</div>
			</div>
		</div>
		<div class="container-fluid fondo-gris-c">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12"><h5 class="fuente-institucional f-color-mdental f-negrita">AL GRADUARTE</h5><h3 class="fuente-institucional f-color-mdental f-negrita text-center">¿DÓNDE PUEDES TRABAJAR?</h3></div>
					<div class="col-12 pt-sans text-justify">
						<div class="row">
				...
				<div class="col-12 col-sm-6 border-left b-color-mdental">
					...
					<div class="col-12 pt-sans text-justify">
						<p> Quien aspira a ingresar al Programa <strong> Técnico Laboral por competencias en Mecánica Dental</strong> de la Corporación Universitaria Autónoma de Nariño, debe ser egresado de la Educación Media Superior o tener cursado y aprobado la educación básica secundaria (9no) y ser mayor de 16 años.  El aspirante debe tener actitudes personales compatibles con las necesidades sociales y los avances en salud y sensibilidad frente a las necesidades humanas de la salud, demostrar sentido crítico, liderazgo social y desarrollo integral, así como los fundamentos básicos en las áreas de biología, lenguaje, química, tecnología y segunda lengua; también debe poseer destrezas y habilidades motoras para la manipulación de materiales y equipos que se utilizarán en el desarrollo del programa.
							<br>
							El aspirante debe tener actitudes sociales y de sensibilización frente a las necesidades de la salud oral de su comunidad para contribuir al mejoramiento de la calidad de vida de las personas mediante el compromiso social y su sentido humano.  Muestra disposición para participar de manera activa y colaborativa en cada uno de los procesos requeridos para su desempeño contributivo, en aras de mejorar la salud oral de la comunidad.
						</p>
					</div>
	...
	<div class="row  fuente-institucional texto-azul">
		<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
			<a class="texto-azul-os sin-texto-subrayado" target="_blanck" href="<?php bloginfo('template_url')?>/docs/malla_curricular/mecanica_dental.pdf" data-toggle="tooltip" data-placement="auto" title="Abrir malla">Malla Curricular</a>
			
		</div>
		<div class="col-4"></div>
		<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
			<a class="texto-azul-os sin-texto-subrayado" target="_mecanica_dental" href="grupos-de-investigacion#grupo6" data-toggle="tooltip" data-placement="auto" title="Ver grupo">Grupos de Investigacón</a>
		</div>
	...
	<div class="row">
		...
		<?php  include_once('slider/slider_dental_docentes.php')?>
