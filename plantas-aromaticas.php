<?php /* Template Name: Plantilla Plantas Aromáticas */ ?>
<!DOCTYPE html>
<html <?php language_attributes();?>>

	<head>
		<?php /*ENLACES DE LIBRERIAS*/  get_header();   ?>
		<title>TRANSFORMACIÓN DE PLANTAS AROMATICAS - AUTÓNOMA DE NARIÑO</title>
	</head>
	...
	<body>
			...
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%"
						src="<?php bloginfo('template_url')?>/img/carreras/plantas-aromaticas-aunar.jpg"
						alt="Transformación de plantas aromaticas autónoma de nariño" />
				</div>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="row ">
				<div class="col-12 col-lg-5 col-md-6 fondo-gris-c p-5">
					<div class="col-12 ">
						<h3 class="fuente-institucional f-color-paromaticas f-negrita">Identificación del programa</h3>
					</div>
						...
						<table class="table table-bordered  table-striped pt-sans f-size-14 texto-azul-os">
							...
							<tbody>
								...
								<tr>
									...
									<td class="borde-1 b-color-paromaticas border-top-0 border-bottom-0">Técnico Profesional en la
										Transformación de Plantas Aromáticas</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 b-color-paromaticas border-top-0 border-bottom-0">Acuerdo Consejo Directivo No.
										41-10 de agosto 30 de 2010, emanado por el Consejo Directivo de la Institución.</td>
								</tr>
								<tr>
									<td class="borde-1 b-color-paromaticas border-bottom-0 border-top-0">Resolución de Registro
										Calificado: </td>
									<td class="borde-1 b-color-paromaticas border-top-0 border-bottom-0">Resolución número 10922 de 28 de
										noviembre de 2011. </td>
								</tr>
								<tr>
				...
				<div class="col-12 col-lg-7 col-md-6 p-5">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-paromaticas f-negrita">Objetivo General</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<p>Formar Técnicos Profesionales en el manejo de los procesos de Transformación, utilizando técnicas
							artesanales y semi-industriales, de plantas aromáticas que influyan en el desarrollo socio económico del
							sector productivo en los procesos de deshidratación, extracción de aceites, esencias y otros subproductos;
							atendiendo los mercados nacionales e internacionales y su sostenibilidad.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container-fluid ">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-paromaticas f-negrita text-center">Misión</h3>
					</div>
					<div class="col-12 pt-sans text-justify">El programa Técnico Profesional en la Transformación de Plantas
						Aromáticas busca formar técnicos y ciudadanos íntegros, con capacidad de contribuir al sector
						agroindustrial, el uso adecuado de la ciencia y la tecnología, para impulsar el desarrollo regional,
						nacional e internacional, en el marco de los principios y valores institucionales.</div>
				</div>
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-paromaticas f-negrita text-center">Visión</h3>
					</div>
					<div class="col-12 pt-sans text-justify">Ser un programa técnico profesional pionero en la transformación de
						plantas aromáticas, que forme técnicos profesionales reconocidos por su excelencia profesional y ética,
						comprometidos con el desarrollo social, científico y tecnológico de la región y del país en el marco de la
						sostenibilidad.
					</div>
				</div>
			</div>
		...
		<div class="container-fluid fondo-gris-c">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h5 class="fuente-institucional f-color-paromaticas f-negrita">AL GRADUARTE</h5>
						<h3 class="fuente-institucional f-color-paromaticas f-negrita text-center">¿DÓNDE PUEDES TRABAJAR?</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<strong>El Técnico Profesional en la Transformación de Plantas Aromáticas</strong> de la Corporación
						Universitaria Autónoma de Nariño, se desempeñará como: técnico en el manejo y mantenimiento de herramientas
						empleadas en el proceso de transformación de plantas aromáticas, dirigir labores de postcosecha de plantas
						aromáticas y su comercialización, asistir al proceso de control de calidad de materia prima y productos
						terminados, realizar de manera técnica los procesos de transformación de plantas aromáticas.
					</div>
				</div>
				<div class="col-12 col-sm-6 border-left b-color-paromaticas">
					<div class="col-12">
						<h5 class="fuente-institucional f-color-paromaticas f-negrita">¿QUÉ HACE UN</h5>
						<h3 class="fuente-institucional f-color-paromaticas f-negrita text-center">TÉCNICO PROFESIONAL EN LA
							TRANSFORMACIÓN DE PLANTAS AROMÁTICAS?</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<strong>El Técnico Profesional en la Transformación de Plantas Aromáticas</strong> está capacitado para
						realizar los procesos de limpieza, selección, clasificación, secado, extracción y empaque de plantas
						aromáticas y subproductos con mentalidad emprendedora, contribuyendo al desarrollo socioeconómico del sector
						productivo de la región, bajo las buenas prácticas de manufactura (BPM) y las normas internacionales de
						calidad.
					</div>
			...
			<div class="row d-flex bd-highlight justify-content-center p-3">
				<div class="col-12 col-sm-5 borde-amarillo flex-fill bd-highlight borde-1 border">
					<div class="row pt-sans texto-azul-os p-2 p-lg-3">
						...
						<div class="col-12">-Conceptos Matemáticos Básicos en el Proceso de Transformación de Plantas Aromáticas.
						</div>
				...
				<div class="col-12 col-sm-5 borde-amarillo flex-fill bd-highlight borde-1 border">
					<div class="row pt-sans texto-azul-os p-2 p-lg-3">
						...
						<div class="col-12">-Empaques, Etiquetas, Embalajes, Almacenamiento y Transporte de Productos Terminados.
						</div>
			...
			<div class="row  fuente-institucional texto-azul">
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
					<a class="texto-azul-os sin-texto-subrayado" target="_blanck"
						href="<?php bloginfo('template_url')?>/docs/malla_curricular/plantas_aromaticas.pdf" data-toggle="tooltip"
				...
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
					<a class="texto-azul-os sin-texto-subrayado" target="_pa" href="grupos-de-investigacion#grupo8"
						data-toggle="tooltip" data-placement="auto" title="Ver grupo">Grupos de Investigacón</a>
				</div>
			</div>
		</div>
		<!-- slider de cada carrera -->
		<?php  include_once('slider/slider_plantas_docentes.php')?>
