  ...
  <ul class="nav d-flex justify-content-center  ">
    ...
    <li class="nav-item">
      <a href="vicerrectoria-de-investigacion" class="nav-link hvr-curl-top-right fuente-institucional f-negrita texto-azul text-center"  id="" role="button" aria-haspopup="true" aria-expanded="false">
        <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/investigacion/investigacion-aunar.png" >
      ...
      <li class="nav-item" id="">
        ...
        <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/investigacion/cidae.png" alt="CIDAE AUNAR"><br> CIDAE</a>
      </li>
      <li class="nav-item" id="">
        <a href="crean" class=" nav-link hvr-curl-top-right fuente-institucional f-negrita texto-azul text-center">
        <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/investigacion/crean.png" alt="CREAN AUNAR" ><br>CREAN</a>
      </li>
      <li class="nav-item" id="">
        <a href="otri" class=" nav-link hvr-curl-top-right fuente-institucional f-negrita texto-azul text-center">
        <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/investigacion/otri.png" alt="OTRI AUNAR" ><br>OTRI</a>
      </li>
      <li class="nav-item" id="">
        <a href="postgrados" class=" nav-link hvr-curl-top-right fuente-institucional f-negrita texto-azul text-center">
        <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/investigacion/postgrados-aunar.png" alt="POSGRADOS AUNAR" ><br>Posgrados</a>
      </li>
      <li class="nav-item" id="">
        <a href="publicaciones" class=" nav-link hvr-curl-top-right fuente-institucional f-negrita texto-azul text-center">
        <img class="img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/investigacion/publicaciones.png" alt="PUBLICACIONES AUNAR" ><br>Publicaciones</a>
      </li>
