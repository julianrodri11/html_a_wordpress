<?php /* Template Name: Plantilla POLITICAS */ ?>
<!DOCTYPE html>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/politicas/politicas-de-proteccion-de-datos.png" alt="Políticias de protección de datos AUNAR"/>
				</div>
			</div>
		</div>		
				...
				<div class="col-12 col-lg-6 d-flex justify-content-center align-items-center fondo-gris-os p-0">
					<div class="row col-12 p-0">
						<div class="col-12 p-0 text-center mx-auto content_img_virtual">
							...
							<a href="#" target="gin">
								<img class="img-fluid img_virtual"  src="<?php bloginfo('template_url')?>/img/politicas/politicias-proteccion-1.jpg" alt="Potítica de protección - AUNAR" width="100%">
							</a>
					...
					<div class="row col-12 ">
						<div class="col-12 py-3 mx-auto texto-azul-os ">
							...
							<div class="pt-sans text-justify pr-lg-5 py-lg-5">
								<a href="#" class="p-2 border borde-azul badge badge-pill hover-amarillo hover-texto-blanco float-right texto-azul sin-texto-subrayado fuente-institucional" target="gin">Leer Más</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-12 col-lg-6 d-flex justify-content-center align-items-center p-0 order-2 order-lg-1">
					<div class="row col-12 ">
						<div class="col-12 p-0 py-md-3 mx-auto texto-azul-os ">
							...
							<div class="pt-sans text-justify pr-lg-5 py-lg-5">
								<a href="#" class="p-2 border borde-azul badge badge-pill hover-amarillo hover-texto-blanco float-right texto-azul sin-texto-subrayado fuente-institucional" target="semilleros">Leer Más</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row col-12 p-0">
						<div class="col-12 p-0 text-center mx-auto content_img_virtual ">
							...
							<a href="#" target="semilleros">
								<img class="img-fluid img_virtual" src="<?php bloginfo('template_url')?>/img/politicas/aviso-autorizacion.jpg" alt="" width="100%">
							</a>
							<div class="cont_texto_secundario">
								<div class="texto_secundario pt-sans texto-azul-os f-negrita">
									<!-- aqui se puede colocar un boton para una acción -->
			...
			<div class="row py-5 py-md-0">
				...
				<div class="col-12 col-lg-6 d-flex justify-content-center align-items-center fondo-gris-os p-0">
					<div class="row col-12 p-0">
						<div class="col-12 p-0 text-center mx-auto content_img_virtual">
							<!-- aqui va todo lo que se quiera centrar -->
							<a href="#" target="trab_grado">
								<img class="img-fluid img_virtual" src="<?php bloginfo('template_url')?>/img/politicas/autorizacion-y-tratamiento.jpg" alt="" width="100%">
							</a>
							<div class="cont_texto_secundario">
								<div class="texto_secundario pt-sans texto-azul-os f-negrita">
									<!-- aqui se puede colocar un boton para una acción -->
				...
				<div class="col-12 col-lg-6 d-flex justify-content-center align-items-center">
					<div class="row col-12 ">
						<div class="col-12 py-3 mx-auto texto-azul-os ">
							...
							<div class="pt-sans text-justify pr-lg-5 py-lg-5">
								<a href="#" class="p-2 border borde-azul badge badge-pill hover-amarillo hover-texto-blanco float-right texto-azul sin-texto-subrayado fuente-institucional" target="trab_grado">Leer Más</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-12 col-lg-6 d-flex justify-content-center align-items-center fondo-gris-os p-0">
					<div class="row col-12 p-0">
						<div class="col-12 p-0 text-center mx-auto content_img_virtual">
							<!-- aqui va todo lo que se quiera centrar -->
							<a href="#" target="trab_grado">
								<img class="img-fluid img_virtual" src="<?php bloginfo('template_url')?>/img/politicas/ayt-menores-de-edad.jpg" alt="" width="100%">
							</a>
							<div class="cont_texto_secundario">
								<div class="texto_secundario pt-sans texto-azul-os f-negrita">
									<!-- aqui se puede colocar un boton para una acción -->
