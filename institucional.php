						...
						<div class="tab-pane fade p-3 fondo-gris-os" id="v-pills-act-10" role="tabpanel" aria-labelledby="v-pills-act-10-tab">
							...
							<div class="col-12 p-2 px-md-5 text-justify pt-sans">
								<table class="table table-hover">
								  <thead>
								    <tr class="bg-dark text-white fondo-azul-oscuro"><th scope="col">Extensión</th><th scope="col">Dependencia</th></tr>
								  </thead>
							  ...
							  <tr class="table-light"><th scope="row"> 207</th> <td> POSGRADOS </td> </tr>
							  ...
							  <!--  -->
							  <tr class="bg-dark text-white fondo-azul-oscuro" ><td colspan="2" class="f-negrita">LÍNEAS TELEFÓNICAS </td> </tr>							  
