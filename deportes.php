		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="img/bienestar/deportes.jpg"/>
				</div>
			</div>
		</div>
			...
			<div class="row m-2 m-md-5">
				<div class="col-12 col-md-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link fuente-institucional texto-azul-os sin-texto-subrayado hvr-underline-from-center f-negrita fondo-gris-os active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Sobre deportes</a>
						<a class="nav-link fuente-institucional texto-azul-os sin-texto-subrayado hvr-underline-from-center f-negrita" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Oferta Deportes</a>
					</div>
				</div>
				<div class="col-12 col-md-9">
					<div class="tab-content pt-sans texto-azul-os" id="v-pills-tabContent">
						...
						<div class="tab-pane fade p-3 fondo-gris-os show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							...
							<div class="col-12 p-2 px-md-5"><img class="img-fluid" width="100%" src="img/bienestar/sobre_deportes.jpg" alt="deportes aunar"></div>
						</div>
						<div class="tab-pane fade p-3 fondo-gris-os" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
							...
							<div class="col-12 p-2 px-md-5"><img class="img-fluid" width="100%" src="img/bienestar/futbol_autonoma_de_narino.jpg" alt="futbol aunar"></div>
							<div class="col-12 p-2 px-md-5"><img class="img-fluid" width="100%" src="img/bienestar/futbol_autonoma_de_narino_2.jpg" alt="futbol aunar"></div>
							<div class="col-12 p-2 px-md-5 text-center" >
								<strong><h1 class="pt-sans f-negrita">Baloncesto</h1></strong> <br>masculino y femenino
							</div>
							<div class="col-12 p-2 px-md-5"><img class="img-fluid" width="100%" src="img/bienestar/baloncesto_autonoma_de_narino.jpg" alt="baloncesto aunar"></div>
							<div class="col-12 p-2 px-md-5"><img class="img-fluid" width="100%" src="img/bienestar/baloncesto_autonoma_de_narino_2.jpg" alt="baloncesto aunar"></div>
							<div class="col-12 p-2 px-md-5 text-center" >
								<strong><h1 class="pt-sans f-negrita">Voleibol</h1></strong>
							</div>
							<div class="col-12 p-2 px-md-5"><img class="img-fluid" width="100%" src="img/bienestar/voleibol_autonoma_de_narino.jpg" alt="voleibol aunar"></div>
							<div class="col-12 p-2 px-md-5 text-center" >
								<strong><h1 class="pt-sans f-negrita">Taekwondo</h1></strong> masculino y femenino
							</div>
							<div class="col-12 p-2 px-md-5"><img class="img-fluid" width="100%" src="img/bienestar/taekwondo_autonoma_de_narino.jpg" alt="taekwondo aunar"></div>
						</div>
					</div>
				</div>
			</div>
