		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/carreras/contaduria-publica-aunar.jpg" alt="Contaduría pública autónoma de nariño" />
				</div>
			</div>
		</div>
		...
		<div class="container-fluid mb-5">
			<div class="row  fuente-institucional texto-azul">
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
					<a class="texto-azul-os sin-texto-subrayado" target="_blanck" href="<?php bloginfo('template_url')?>/docs/malla_curricular/contaduria_publica.pdf" data-toggle="tooltip" data-placement="auto" title="Abrir malla">Malla Curricular</a>
				</div>
				<div class="col-4"></div>
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
					<a class="texto-azul-os sin-texto-subrayado" target="_cp" href="grupos-de-investigacion#grupo5" data-toggle="tooltip" data-placement="auto" title="Ver grupo">Grupos de Investigacón</a>
				</div>
