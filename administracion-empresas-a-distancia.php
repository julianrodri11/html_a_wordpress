...
/carreras/administracion-de-empresas-a-distancia-aunar.jpg" alt="Administración de empresas a distancia en autónoma de nariño" />
				</div>
			</div>
		</div>
		...
		<!-- malla curricular -->
		<?php include_once('secciones/malla_curricular/admon_distancia.php'); ?>
		<?php  get_footer(); ; ?>
	</body>
</html>