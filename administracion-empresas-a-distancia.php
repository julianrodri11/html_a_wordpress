<?php /* Template Name: Plantilla Adm Empresas a Distancia */ ?>
<!DOCTYPE html>
<html <?php language_attributes();?>>
	<head>
		<?php /*ENLACES DE LIBRERIAS*/  get_header();   ?>
		<title>ADMINISTRACIÓN DE EMPRESAS A DISTANCIA - AUTÓNOMA DE NARIÑO</title>
	</head>
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/carreras/administracion-de-empresas-a-distancia-aunar.jpg" alt="Administración de empresas a distancia en autónoma de nariño" />
				</div>
			</div>
		</div>
						...
						<table class="table table-bordered  table-striped pt-sans f-size-14 texto-azul-os">
							...
							<tbody>
								...
								<tr>
									...
									<td class="borde-1 b-color-aempresas border-top-0 border-bottom-0" >Administración de Empresas a Distancia</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 b-color-aempresas border-top-0 border-bottom-0" >Educación a Distancia Apoyado en Herramientas Virtuales</td>
								</tr>
								<tr>
									<td class="borde-1 b-color-aempresas border-bottom-0 border-top-0" >Número de Semestres:</td>
									<td class="borde-1 b-color-aempresas border-top-0 border-bottom-0" >9 semestres</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 b-color-aempresas border-top-0 border-bottom-0" >Acuerdo de Consejo Directivo No. 69-10 de diciembre 9 de 2010.</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 b-color-aempresas border-top-0 border-bottom-0" >102519</td>
								</tr>
								<tr>
									<td class="borde-1 b-color-aempresas border-bottom-0 border-top-0" >Créditos: </td>
									<td class="borde-1 b-color-aempresas border-top-0 border-bottom-0" ></td>
								</tr>
								<tr>
		...
		<div class="container-fluid ">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					...
					<div class="col-12 pt-sans text-justify">El Programa de Administración de Empresas a distancia de La Corporación Universitaria Autónoma de Nariño, crea, dirige, conserva, participa y aprovecha conocimiento organizacional y administrativo, para   la formación de profesionales con perspectiva global, estratégica, comprensión humana y enfoque social capaz de ofrecer servicios a las comunidades y unidades económicas, que requieran soporte profesional en el campo de la gestión empresarial.</div>
				</div>
				<div class="col-12 col-sm-6 ">
					<div class="col-12"> <h3 class="fuente-institucional f-color-aempresas f-negrita text-center">Visión</h3></div>
					<div class="col-12 pt-sans text-justify">En el año 2025 el Programa de Administración de Empresas a distancia será reconocido en los contextos local, nacional e internacional por la formación de profesionales íntegros e idóneos con autonomía intelectual e investigativa, comprometidos desde lo organizacional y administrativo con las causas sociales.
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid mb-5">
			<div class="row  fuente-institucional texto-azul">
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
					<a class="texto-azul-os sin-texto-subrayado" target="_blanck" href="<?php bloginfo('template_url')?>/docs/malla_curricular/administracion_empresas_distancia.pdf" data-toggle="tooltip" data-placement="auto" title="Abrir malla">Malla Curricular</a></div>
					<div class="col-4"></div>
					<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
						<a class="texto-azul-os sin-texto-subrayado" target="_admon" href="grupos-de-investigacion#grupo8" data-toggle="tooltip" data-placement="auto" title="Ver grupo">Grupos de Investigacón</a>
					</div>
