<?php /* Template Name: Plantilla SGSST */ ?>
<!DOCTYPE html>
<html <?php language_attributes();?>>
	<head>
		<?php /*ENLACES DE LIBRERIAS */  get_header();   ?>
		<!--TÍTULO DE LA PÁGINA-->
		<title>SEGURIDAD Y SALUD EN EL TRABAJO - AUTÓNOMA DE NARIÑO</title>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/sitioenconstruccion_aunar.webp" alt="SGSST AUNAR"/>
				</div>
			</div>
		</div>
					...
					<div class="tab-content pt-sans texto-azul-os" id="v-pills-tabContent">
						...
						<div class="tab-pane fade p-3 fondo-gris-os show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							<div class="col-12 p-2 px-md-5 text-center">
								<span class="text-center pt-sans"> <h3><strong>SEGURIDAD Y SALUD <br>	 EN EL TRABAJO</strong></h3></span>
							</div>
							<div class="col-12 p-2 px-md-5 text-justify">
								<p class="pt-sans">
									El Sistema de Gestión de Seguridad y Salud en el Trabajo SG-SST, de la Corporacion
									Universitaria Autónoma de Nariño, tiene como propósito la estructuración de la acción
									conjunta entre el empleador y los trabajadores, en la aplicación de las medidas de
									...
									lugar de trabajo; con la participación activa de los trabajadores en pro de la seguridad y la
									salud de todos los que participan en la cadena de valor de la Institución.
								</p>
							</div>
						</div>
						...
						<div class="tab-pane fade p-3 fondo-gris-os" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
							...
							<div class="col-12 p-2 px-md-5 text-justify">
								<p class="pt-sans">
									La Corporación Universitaria Autónoma de Nariño,  desea contribuir al mejoramiento de la  Seguridad y Salud de los trabajadores, mediante  actividades de promoción y prevención, logrando una productividad y  bienestar integral que , garantice condiciones de trabajo óptimas, para alcanzar una verdadera cultura de la seguridad y salud en el trabajo 
								</p>
							</div>
							<div class="col-12 p-2 px-md-5 text-center">
							...
							<div class="col-12 p-2 px-md-5 text-justify">
								<p class="pt-sans">								
									Deseamos tener un entorno laboral  saludable, libre de accidentes y enfermedades, donde los trabajadores sean conscientes de la importancia del autocuidado y generen mayor productividad a la Institución.
								</p>
							</div>
						</div>
						...
						<div class="col-12 p-2 px-md-5 text-center">
								<span class="text-center pt-sans"> <h3><strong>OBJETIVO</strong></h3></span>
							</div>
							<div class="col-12 p-2 px-md-5 text-justify pt-sans">
								Garantizar condiciones de trabajo seguras y saludables en el desarrollo de las diferentes actividades productivas en la Corporacion Universitaria Autonoma de Nariño, a través de la promoción de la salud y de la identificación, evaluación y control de los riesgos ocupacionales, con el fin de evitar accidentes, enfermedades laborales y otras situaciones que afecten la calidad de vida de los trabajadores.
							</div>
						</div>
						...
						<div class="tab-pane fade p-3 fondo-gris-os" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
							<div class="col-12 p-2 px-md-5 text-center">
								<span class="text-center pt-sans"> <h3><strong>ALCANCE</strong></h3></span>
							</div>
							<div class="col-12 p-2 px-md-5 text-justify pt-sans">
								El Sistema de Gestión de Seguridad y Salud en el trabajo (SG-SST) aplica a todos los trabajadores de la Corporación Universitaria Autónoma de Nariño, vinculados directamente o a través de contratos temporales de trabajo y aquellos otros que la Ley establezca, en los diferentes puestos, Sedes y áreas de operación.
							</div>
						...
						<div class="tab-pane fade p-3 fondo-gris-os" id="v-pills-act-deportivas" role="tabpanel" aria-labelledby="v-pills-act-deportivas-tab">
							<div class="col-12 p-2 px-md-5 text-center">
								<span class="text-center pt-sans"> <h3><strong>POLÍTICA EN SEGURIDAD Y SALUD EN EL TRABAJO</strong></h3></span>
							</div>
							<div class="col-12 p-2 px-md-5 text-justify">							
								<p class="pt-sans">
								La Corporación Universitaria Autónoma de Nariño comprometida con la Seguridad y Salud de sus trabajadores  contribuye con el mejoramiento de las condiciones de trabajo, salud y seguridad de todos los trabajadores, contratistas y partes interesadas. Mediante el desarrollo del Sistema de Gestión Seguridad y Salud en el Trabajo. <br> 
								Para el desarrollo de este Sistema la Institución, cuenta con el apoyo, del COPASST, Comité de Convivencia Laboral, Brigada de Emergencia y trabajadores en general, mediante el compromiso de los mismos con las actividades de Seguridad y Salud en el Trabajo. <br>								 
								Hay un firme Compromiso para cumplir con la Legislación Colombiana en Seguridad y Salud en el Trabajo que aplique a la Institución. <br>
								</p>
							</div>							
						</div>
						<!-- pestaña 6-->
						<div class="tab-pane fade p-3 fondo-gris-os" id="v-pills-act-6" role="tabpanel" aria-labelledby="v-pills-act-6-tab">
							<div class="col-12 p-2 px-md-5 text-center">
								<span class="text-center pt-sans"> <h3><strong>FACTORES DE RIESGO</strong></h3></span>
							</div>
							<div class="col-12 p-2 px-md-5 text-justify">
								<p class="pt-sans">
									Los peligros existentes en la Institución, están constituidos principalmente por:
									<br>
								</p>
							</div>
							<div class="col-12 p-2 px-md-5 text-justify">
									<table class="table table-hover">
										 <thead>
								    <tr class="bg-dark text-white fondo-azul-oscuro"><th scope="col">Riesgo Biomecánico</th></tr>
								  	</thead>									  
									  <tr class="table-light">  <td >Posiciones Forzadas</td></tr>
									  <tr class="table-dark" >  <td >Sobre esfuerzos</td></tr>
									  <tr class="table-light">  <td >Posiciones estáticas</td></tr>
									  <tr class="table-dark" >  <td >Manipulación de cargas</td></tr>
									  <tr class="table-light">  <td >Movimientos repetitivos</td></tr>									  
										 <thead>
								    <tr class="bg-dark text-white fondo-azul-oscuro"><th scope="col">Riesgo Psicosocial</th></tr>
								  	</thead>
									  
									  <tr class="table-light">  <td >Gestión organizacional</td></tr>
									  <tr class="table-dark" >  <td >Condiciones de la tarea</td></tr>
									  <tr class="table-light">  <td >Jornada de trabajo</td></tr>
									  <tr class="table-dark" >  <td >Interfase persona - tarea</td></tr>
									  <tr class="table-light">  <td >Características de la organización</td></tr>
									  <tr class="table-dark" >  <td >Características del grupo social</td></tr>

									  
									  <tr class="table-light">  <td >Lorem ipsum.</td></tr>
									  <tr class="table-dark" >  <td >Lorem ipsum.</td></tr>
									  <tr class="table-light">  <td >Lorem ipsum.</td></tr>
									  <tr class="table-dark" >  <td >Lorem ipsum.</td></tr>
									  <tr class="table-light">  <td >Lorem ipsum.</td></tr>
									  <tr class="table-dark" >  <td >Lorem ipsum.</td></tr>
