<?php /* Template Name: Plantilla Adm Empresas */ ?>
<!DOCTYPE html>
<html <?php language_attributes();?>>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/carreras/administracion-de-empresas.jpg" alt="Administración de empresas - autónoma de nariño" />
				</div>
			</div>
		</div>
	...
	<div class="row  fuente-institucional texto-azul">
		<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
			<a class="texto-azul-os sin-texto-subrayado" target="_blanck" href="docs/malla_curricular/administracion_empresas.pdf" data-toggle="tooltip" data-placement="auto" title="Abrir malla">Malla Curricular</a></div>
			<div class="col-4"></div>
					...
					<div class="row d-flex justify-content-center">
						...
						<div class="col-12 col-md-6 pt-sans texto-azul-os">
							...
							<div id="collapseThree" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Ingeniero Industrial, Especialización En Logística Comercial Nacional E Internacional<br>
									Especialista  En Alta Gerencia <br>
							...
							<div class="card-header collapsed bg-white f-negrita" data-toggle="collapse" data-parent="#accordion" href="#collapseSix">
								<a class="card-title pl-3 pt-sans texto-azui-os f-negrita a-new pointer hover-texto-amarillo">
									Cesar Javier Sinisterra Cortes
								</a>
							</div>
							...
							<div id="collapseHeight" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									...
									Especialista En Gerencia De Mercadeo <br>
									Maestría En Mercadeo Agroindustrial (Pendiente Trabajo De Grado) <br>
									Diplomado En Dirección Universitaria <br>
							...
							<div id="collapse16" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Contador Público, Maestría En Gerencia Y Auditoria Tributaria
								</div>
							</div>
							...
							<div class="card-header collapsed bg-white f-negrita" data-toggle="collapse" data-parent="#accordion" href="#collapse20">
								<a class="card-title pl-3 pt-sans texto-azui-os f-negrita a-new pointer hover-texto-amarillo">
									Jaime Alberto Argoty Chamorro
								</a>
							</div>
							<div id="collapse20" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Economista-Esp- Finanzas- Mg-
								</div>
							</div>
							...
							<div id="collapse25" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Contador Publico <br> Especialista En Gerencia Tributaria
								</div>
							</div>
						</div>
						<!-- fin lado ziquierdo -->
						...
						<div class="col-12 col-md-6 pt-sans texto-azul-os">
							...
							<div class="card-header collapsed bg-white f-negrita" data-toggle="collapse" data-parent="#accordion" href="#collapse27">
								<a class="card-title pl-3 pt-sans texto-azui-os f-negrita a-new pointer hover-texto-amarillo">
									Silvio Nicolás Madroñero Madroñero
								</a>
							</div>
							<div id="collapse27" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Doc. En Economía-Esp-Gerencia De Proyectos
								</div>
							</div>
							...
							<div class="card-header collapsed bg-white f-negrita" data-toggle="collapse" data-parent="#accordion" href="#collapse34">
								<a class="card-title pl-3 pt-sans texto-azui-os f-negrita a-new pointer hover-texto-amarillo">
									Roberto Ivan Bravo Sañudo
								</a>
							</div>
							<div id="collapse34" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Administrador De Empresas-Espe Alta Gerencia
								</div>
							</div>
							...
							<div id="collapse37" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									...
									Mg. Modelos De La Enseñanza Problemita
								</div>
							</div>
							...
							<div id="collapse39" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									...
									Financiera, Master Procesos De Dirección Empresarial
								</div>
							</div>
							...
							<div id="collapse42" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Esp Mercadeo Mg-Administración Y Competitividad
								</div>
							</div>
							...
							<div class="card-header collapsed bg-white f-negrita" data-toggle="collapse" data-parent="#accordion" href="#collapse44">
								<a class="card-title pl-3 pt-sans texto-azui-os f-negrita a-new pointer hover-texto-amarillo">
									Luis Eduardo Enríquez Lara
								</a>
							</div>
							<div id="collapse44" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Admon - Mg - Gerencia Y Asesoría Financiera
								</div>
							</div>
							...
							<div class="card-header collapsed bg-white f-negrita" data-toggle="collapse" data-parent="#accordion" href="#collapse49">
								<a class="card-title pl-3 pt-sans texto-azui-os f-negrita a-new pointer hover-texto-amarillo">
									Ricardo Mauricio Ortega
								</a>
							</div>
							<div id="collapse49" class="collapse" data-parent="#accordion" >
								<div class="card-body p-4 text-justify">
									Lic Matemáticas <br>
									Espe Docencia Y Lúdicas <br>
									Mg Pedagogía Y Educación
								</div>
							</div>
