<?php /* Template Name: Plantilla Ing. Mecánica */ ?>
<!DOCTYPE html>
<html <?php language_attributes();?>>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%" src="<?php bloginfo('template_url')?>/img/carreras/ingenieria-mecanica-aunar.jpg" alt="ingeniería mecánica autónoma de nariño" />
				</div>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="row ">
				<div class="col-12 col-lg-5 col-md-6 fondo-gris-c p-5">
					<div class="col-12 "> <h3 class="fuente-institucional f-color-imecanica f-negrita">Identificación del programa</h3></div>
					<div class="col-12">
					...
					<div class="col-12 mt-5">
						<label class="fuente-institucional f-color-imecanica f-negrita">CONTACTOS</label><br>
						<label class="fuente-institucional ">sandra.cordoba@aunar.edu.co</label>
					</div>
				</div>
				<div class="col-12 col-lg-7 col-md-6 p-5">
					<div class="col-12"> <h3 class="fuente-institucional f-color-imecanica f-negrita">Objetivo General</h3></div>
	...
	<div class="row  fuente-institucional texto-azul">
		...
		<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
			<a class="texto-azul-os sin-texto-subrayado" target="_mecanica" href="grupos-de-investigacion#grupo1" data-toggle="tooltip" data-placement="auto" title="Ver grupo">Grupos de Investigacón</a>
		</div>
