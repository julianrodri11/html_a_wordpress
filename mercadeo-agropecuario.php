<?php /* Template Name: Plantilla Mercadeo Agropecuario */ ?>
<!DOCTYPE html>
<html <?php language_attributes();?>>

	<head>
		<?php /*ENLACES DE LIBRERIAS*/  get_header();   ?>
		<title>MERCADEO AGROPECUARIO AUTÓNOMA DE NARIÑO</title>
	</head>
	...
	<body>
			...
			<div class="row">
				<div class="col-12 p-0">
					<img class="mx-auto img-fluid" width="100%"
						src="<?php bloginfo('template_url')?>/img/carreras/mercadeo-agropecuario-aunar.jpg"
						alt="Mercadeo agropecuario autónoma de nariño" />
				</div>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="row ">
				<div class="col-12 col-lg-5 col-md-6 fondo-gris-c p-5">
					<div class="col-12 ">
						<h3 class="fuente-institucional f-color-magropecuario f-negrita">Identificación del programa</h3>
					</div>
					<div class="col-12">
						<table class="table table-bordered  table-striped pt-sans f-size-14 texto-azul-os">
							...
							<tbody>
								...
								<tr>
									...
									<td class="borde-1 b-color-magropecuario border-top-0 border-bottom-0">Tecnología en Mercadeo
										Agropecuario</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="borde-1 b-color-magropecuario border-top-0 border-bottom-0">Tecnólogo en Mercadeo
										Agropecuario</td>
								</tr>
								<tr>
									<td class="borde-1 b-color-magropecuario border-bottom-0 border-top-0">Modalidad:</td>
									<td class="borde-1 b-color-magropecuario border-top-0 border-bottom-0">Educación Modalidad Virtual
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="borde-1 b-color-magropecuario border-bottom-0 border-top-0">Periodicidad de la admisión:
									</td>
								...
								<tr>
									...
									<td class="borde-1 b-color-magropecuario border-top-0 border-bottom-0">Acuerdo Consejo Directivo No.
										43-10 del 25 de agosto de 2010</td>
								</tr>
								<tr>
									<td class="borde-1 b-color-magropecuario border-bottom-0 border-top-0">Resolución de Registro
										Calificado: </td>
									<td class="borde-1 b-color-magropecuario border-top-0 border-bottom-0">Resolución número 10921 del 28
										de noviembre de 2011</td>
								</tr>
								<tr>
				...
				<div class="col-12 col-lg-7 col-md-6 p-5">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-magropecuario f-negrita">Objetivo General</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<p>Formar Tecnólogos competentes en el proceso de comercialización para apoyar al sector productivo
							agropecuario en las actividades de oferta, logística, distribución, promoción, publicidad, venta y consumo
							de productos de origen agropecuario en un contexto regional, nacional e internacional.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container-fluid ">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-magropecuario f-negrita text-center">Misión</h3>
					</div>
					<div class="col-12 pt-sans text-justify">Dando cumplimiento a la Misión de la Institución comprometida con la
						Cultura, la Ciencia e Investigación, conforme a los lineamientos de la excelencia en la formación, el
						programa Tecnológico en Mercadeo Agropecuario, formar profesionales tecnológicos competentes y capacitados,
						para construir eficientemente los procesos de comercialización de las empresas del sector productivo
						agropecuario y agroindustrial, impulsando el desarrollo en el marco productivo.</div>
				</div>
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h3 class="fuente-institucional f-color-magropecuario f-negrita text-center">Visión</h3>
					</div>
					<div class="col-12 pt-sans text-justify">Los tecnólogos estarán a la vanguardia en inteligencia de mercado por
						medio de la innovación tecnológica para la transformación dentro de la economía mundial, coadyubando al
						desarrollo sostenible regional, nacional e internacional.
					</div>
				</div>
			</div>
		</div>
		<div class="container-fluid fondo-gris-c">
			<div class="row p-4 m-1 ">
				<div class="col-12 col-sm-6 ">
					<div class="col-12">
						<h5 class="fuente-institucional f-color-magropecuario f-negrita">AL GRADUARTE</h5>
						<h3 class="fuente-institucional f-color-magropecuario f-negrita text-center">¿DÓNDE PUEDES TRABAJAR?</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<strong>El Tecnólogo en Mercadeo Agropecuario </strong> de la Corporación Universitaria Autónoma de Nariño,
						se desempeñará como: técnico o administrativo en el campo de la comercialización de productos agropecuarios
						del sector público o privado; en la formulación de proyectos para el sector agropecuario, en la
						administración de plazas de mercado mayoristas, cadenas de supermercados, asociaciones o cooperativas de
						productores agropecuarios, fondos de comercialización o crear empresa.
					</div>
				</div>
				<div class="col-12 col-sm-6 border-left b-color-magropecuario">
					<div class="col-12">
						<h5 class="fuente-institucional f-color-magropecuario f-negrita">¿QUÉ HACE UN</h5>
						<h3 class="fuente-institucional f-color-magropecuario f-negrita text-center">TECNÓLOGO EN MERCADEO
							AGROPECUARIO?</h3>
					</div>
					<div class="col-12 pt-sans text-justify">
						<strong>El Tecnólogo en Mercadeo Agropecuario</strong> estará capacitado para administrar centros de acopio,
						cadenas de supermercados, asociaciones o cooperativas de productos agropecuarios y fondos de
						comercialización, formular y aplicar proyectos de investigación en producción agropecuaria, desempeñarse
						como técnico o administrativo en el campo de la comercialización de productos agropecuarios a nivel nacional
						e internacional.
					</div>
				</div>
			</div>
			...
			<div class="row d-flex bd-highlight justify-content-center p-3">
				<div class="col-12 col-sm-5 borde-amarillo flex-fill bd-highlight borde-1 border">
					<div class="row pt-sans texto-azul-os p-2 p-lg-3">
						...
						<div class="col-12">-Conceptos Matemáticos Fundamentales en la Comercialización de Productos Agropecuarios.
						</div>
				...
				<div class="col-12 col-sm-5 borde-amarillo flex-fill bd-highlight borde-1 border">
					<div class="row pt-sans texto-azul-os p-2 p-lg-3">
						...
						<div class="col-12">-Procedimientos Estadísticos para organizar la Información en la Comercialización de
							Productos Agropecuarios</div>
						<div class="col-12">-Políticas de Manejo Agrario y Ambiental para la Comercialización de Productos
							Agropecuarios. </div>
				...
				<div class="col-12 col-sm-5 borde-amarillo flex-fill bd-highlight borde-1 border">
					<div class="row pt-sans texto-azul-os p-2 p-lg-3">
						...
						<div class="col-12">-Herramientas Informáticas en los Procesos de Comercialización de Productos
							Agropecuarios.</div>
				...
				<div class="col-12 col-sm-5 borde-amarillo flex-fill bd-highlight borde-1 border">
					<div class="row pt-sans texto-azul-os p-2 p-lg-3">
						<div class="col-12 text-center d-flex justify-content-center fondo-gris-c mt-5">
							<div class="row p-2 ">
								<div class="col-12  "><strong>V Semestre</strong></div>
							</div>
						</div>
				...
				<div class="col-12 col-sm-5 borde-amarillo flex-fill bd-highlight borde-1 border">
					<div class="row pt-sans texto-azul-os p-2 p-lg-3">
						<div class="col-12 text-center d-flex justify-content-center fondo-gris-c mt-5">
							<div class="row p-2 ">
								<div class="col-12  "><strong>VI Semestre</strong></div>
							</div>
						</div>
			...
			<div class="row  fuente-institucional texto-azul">
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita pointer">
					<a class="texto-azul-os sin-texto-subrayado" target="_blanck"
						href="<?php bloginfo('template_url')?>/docs/malla_curricular/mercadeo_agropecuario.pdf"
						data-toggle="tooltip" data-placement="auto" title="Abrir malla">Malla Curricular</a>
				</div>
				<div class="col-4"></div>
				<div class="col-4 p-4  hover-texto-blanco text-center fondo-amarillo-intenso f-negrita">
					<a class="texto-azul-os sin-texto-subrayado" target="_meragr" href="grupos-de-investigacion/#grupo8"
						data-toggle="tooltip" data-placement="auto" title="Ver grupo">Grupos de Investigacón</a>
				</div>
			</div>
		</div>
		<!-- slider de cada carrera -->
		<?php  include_once('slider/slider_mercadeo_docentes.php')?>
									...
									<div class="col-12 col-md-6 pt-sans texto-azul-os">
											...
											<div id="collapseOne" class="collapse" data-parent="#accordion" >
													<div class="card-body p-4 text-justify">
															Bióloga con énfasis en ecología <br>
															Magister (c) en Desarrollo sostenible y medio ambiente <br>
															Docente Investigador hace 12 años <br>
