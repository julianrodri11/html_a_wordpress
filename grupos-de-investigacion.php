...
<html <?php language_attributes();?>>
	<head>
		...
		<!--TÍTULO DE LA PÁGINA-->
		<title>GRUPOS DE INVESTIGACIÓN - AUTÓNOMA DE NARIÑO</title>
			...
			<div class="row fuente-institucional texto-azul-os p-sm-5 d-flex justify-content-center">
				<div class="col-9 pt-lg-3 mt-lg-4 f-myriad text-justify">
					...
					<p>
						...
						Adelantar procesos de investigación científica, de innovación o desarrollo tecnológico y de desarrollo sostenible, como respuesta a las necesidades institucionales o del entorno; en articulación con los procesos institucionales de formación académica, de proyección social y de producción de conocimiento.
					</p>
					<p>
						<br> <strong>Visión</strong><br>
						Ser líderes a nivel regional en el desarrollo de proyectos de innovación, desarrollo tecnológico y desarrollo sostenible, en el marco de la alianza universidad - empresa - estado, para 2020.
					</p>
					<p>
		...
		<div class="container-fluid">
			<div class="row d-flex justify-content-center fuente-institucional f-negrita texto-azul-os">
				...
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-os p-2">
					<div class="row">
						<div class="col-12 col-sm-6 text-left text-sm-right">Área:</div>
						<div class="col-12 col-sm-6">Diseño de Modas</div>
					</div>
				</div>
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-c  p-2">
					<div class="row">
		...
		<div class="container-fluid">
			<div class="row fuente-institucional texto-azul-os p-sm-5 d-flex justify-content-center">
				<div class="col-9 pt-lg-3 mt-lg-4 f-myriad text-justify">
					<p>
						<br> <strong>Descripción:</strong><br>
						Promoviendo el compromiso con la producción científica y el desarrollo de la región y el país, en el año 2012 la Universidad Autónoma de Nariño crea el Grupo de Investigación MODA + CULTURA, vinculado a la línea de Investigación “Programa Procesos Culturales” y los campos de trabajo; “Patrimonios culturales y ambientales”, “Desarrollo Empresarial” y “Observatorio de Tendencias” del programa de Diseño de Modas de la misma institución académica.
		...
		<div class="container-fluid">
			<div class="row d-flex justify-content-center fuente-institucional f-negrita texto-azul-os">
				<div class="col-8 col-md-7 border-bottom border-top borde-azul fondo-gris-os p-2">
					<div class="row">
						<div class="col-12 col-sm-6 text-left text-sm-right">Coordinador:</div>
						<div class="col-12 col-sm-6">Diana María Revelo Tovar</div>
					</div>
				</div>
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-c  p-2">
					<div class="row">
						<div class="col-12 col-sm-6 text-left text-sm-right">Correo electrónico:</div>
						<div class="col-12 col-sm-6">irop@aunar.edu.co</div>
					</div>
				</div>
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-os p-2">
					<div class="row">
				...
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-os p-2">
					<div class="row">
						<div class="col-12 col-sm-6 text-left text-sm-right">Área:</div>
						<div class="col-12 col-sm-6">Mecánica Dental</div>
					</div>
				</div>
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-c  p-2">
					<div class="row">
		...
		<div class="container-fluid">
			<div class="row d-flex justify-content-center fuente-institucional f-negrita texto-azul-os">
				<div class="col-8 col-md-7 border-bottom border-top borde-azul fondo-gris-os p-2">
					<div class="row">
						<div class="col-12 col-sm-6 text-left text-sm-right">Coordinador:</div>
						<div class="col-12 col-sm-6">Irina Margarita Jurado Paz</div>
					</div>
				</div>
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-c  p-2">
					<div class="row">
						<div class="col-12 col-sm-6 text-left text-sm-right">Correo electrónico:</div>
						<div class="col-12 col-sm-6">egresados@aunar.edu.co</div>
					</div>
				</div>
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-os p-2">
					<div class="row">
				...
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-os p-2">
					<div class="row">
						<div class="col-12 col-sm-6 text-left text-sm-right">Área:</div>
						<div class="col-12 col-sm-6">Egresados AUNAR</div>
					</div>
				</div>
				<div class="col-8 col-md-7 border-bottom borde-azul fondo-gris-c  p-2">
					<div class="row">
